import 'package:demo_shop/api/mine.dart';
import 'package:demo_shop/components/Home/DemoMoreList.dart';
import 'package:demo_shop/components/Mine/DemoGuess.dart';
  ...
  Widget build(BuildContext context) {
    return CustomScrollView(
      ...
      slivers: [
        ...
        SliverPersistentHeader(delegate: DemoGuess(), pinned: true),
        DemoMoreList(recommendList: _list),
        // 猜你喜欢
      ],
    );
  }
